# CLEANED + COMMENTED + ANNOTATED VERSION READY TO GIT PUSH
import torch
from torch import nn

from torch_scatter import scatter_mean, scatter_max, scatter_add

from mot_gnn import MLP


class MetaLayer(torch.nn.Module):
    """
    Core Message Passing Network Class. 
    minor modifications to the acc torch_geometrics 
    """
